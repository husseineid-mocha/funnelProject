...
describe('getHealth', function() {
    ...
    it('should return WARNING if average altitude is less than 160km', function() {
    ...
    it('should return Sustained if average altitude was less than 160km but now above', function() {
